    ...
    public class BikeShopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Store>()
                ...
                new Store { StoreId = 3, StoreName = "Bloemfontein Shop", Contacts = 0123654, Email = "bikeBloem@bikeshop.co.za", Address = "Rich street 10A Bloem FS", ProductID = 3 }
                );
            modelBuilder.Entity<Order>()
                .HasData(
                new Order { OrderId = 1, OrderDate= DateTime.Parse("2020/12/15"), RequiredDate= DateTime.Parse("2021/01/01"), ShippedDate= DateTime.Parse("2020/12/28"), CustomerID = 1, StoreID = 1},
                new Order { OrderId = 2, OrderDate = DateTime.Parse("2021/12/15"), RequiredDate = DateTime.Parse("2022/01/01"), ShippedDate = DateTime.Parse("2021/12/28"), CustomerID = 2, StoreID = 2 }
